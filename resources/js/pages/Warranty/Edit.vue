...
const form = useForm({
    asset_id: props.warranty.asset_id ?? '',
    description: props.warranty.description ?? '',
    provider: props.warranty.provider ?? '',
    length_months: props.warranty.length_months ?? 12,
    start_date: props.warranty.start_date ?? '',
    expiry_date: props.warranty.expiry_date ?? '',
...
<template>
    <AppLayout>
        <Head :title="`Edit Warranty · ${warranty.description}`" />
            ...
            <GlassCard>
                <header class="mb-6 border-b border-slate-200 pb-4 dark:border-slate-700">
                    ...
                    <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">
                        Update warranty coverage, provider details, and important notes.
                    </p>
                </header>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                Clear this value to auto-calculate using the coverage length.
                            </p>
                        </div>
                    </div>
