...
const submit = () => {
    form.post('/setup/sites', {
        onSuccess: () => {
            show('Site created successfully.', 'success');
        },
        onError: () => {
            show('Failed to create site.', 'danger');
        },
    });
};
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="[{ title: 'Setup', href: '' }, { title: 'Sites', href: '/setup/sites' }, { title: 'Create', href: '/setup/sites/create' }]">
        <div class="space-y-6">
